...
class TIMU_BMP_Support {
    ...
    /**
     * Handle the Vortops API key save form submission.
     *
     * @return void
     */
    public static function handle_vortops_save() {
        check_admin_referer( 'timu_bmp_vortops_save', 'timu_bmp_vortops_nonce' );
        if ( ! current_user_can( 'manage_options' ) ) {
            wp_die( esc_html__( 'Unauthorized.', 'thisismyurl-bmp-support' ) );
        }
        ...
        wp_safe_redirect( add_query_arg(
            array( 'page' => 'bmp-optimizer', 'tab' => 'settings', 'vortops-saved' => '1' ),
            admin_url( 'tools.php' )
        ) );
        exit;
    }
